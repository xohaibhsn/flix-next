...
import { buildWhatsAppUrl } from "@/lib/cms/contact";
...
function ContactAndChromeSettings({
  ...
  const generatedWa = buildWhatsAppUrl(settings.whatsapp, settings.whatsappMessage);
    ...
    <>
      <section className="rounded-xl border border-line bg-white p-5">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          ...
          <Field label="Default WhatsApp message" hint="Used as a fallback. Sales, plan, and visit messages are generated by the website.">
            <TextInput
      ...
      <section className="rounded-xl border border-line bg-white p-5">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          ...
          <Field label="CTA URL" hint="Ignored on the public site when the CTA label is sales-oriented (for example Get Started) and WhatsApp is enabled.">
