...
<p>UK streaming should feel ordinary: the news in the morning, a film on Friday, sport when it is on, something for the children at the weekend. Flix IPTV is aimed at that rhythm, not at people who want to tinker with settings all evening.</p>
...
<h2>Why customers choose Flix IPTV</h2>
...
<p>Flix IPTV is here for UK customers who want television that is easy to live with. Message us on WhatsApp when you are ready to get started.</p>`;

export const SUBSCRIPTION_SEO_HTML = `<p>This page is for UK customers who want a streaming subscription they can use on the television they already own. Flix IPTV offers streaming packages for Firestick, Fire TV, Smart TV, Android TV, mobile, tablet and laptop, with setup and account help through WhatsApp. You will see the word IPTV in the address bar because that is how many people still search; the service itself is easier to understand as live TV streaming and on-demand entertainment in one place.</p>
...
<p>A Fully Loaded Firestick experience, in the way customers usually mean it, is about having the right TV apps ready on Firestick — not about us posting a stick in the mail. Flix IPTV does not sell hardware. Bring the Fire TV you have, or buy one locally if you still need one, then we will help with the streaming side.</p>
...
<p>A Flix IPTV subscription is meant to be ordinary in the best sense: you pay for a streaming package, you set it up with help, and you watch on the devices you already have.</p>
<ul>
